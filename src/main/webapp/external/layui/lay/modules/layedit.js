...
;layui.define(["layer", "form"], function (t) {
    ...
    c.prototype.set = function (t) {
        ...
        var a = this, n = a.config, r = "layui-layedit", c = e("string" == typeof t ? "#" + t : t),
            ...
            m = e(['<div class="' + r + '">', '<div class="layui-unselect layui-layedit-tool">' + f + "</div>", '<div class="layui-layedit-iframe">', '<iframe articleId="' + u + '" name="' + u + '" textarea="' + t + '" frameborder="0"></iframe>', "</div>", "</div>"].join(""));
