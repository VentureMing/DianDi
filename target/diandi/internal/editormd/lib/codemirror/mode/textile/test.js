...
(function() {
  ...
  MT('divWithAttribute',
      '[punctuation div][punctuation&attribute (#my-articleId)][punctuation . foo bar]');

  MT('divWithAttributeAnd2emRightPadding',
      '[punctuation div][punctuation&attribute (#my-articleId)((][punctuation . foo bar]');

  MT('divWithClassAndId',
      '[punctuation div][punctuation&attribute (my-class#my-articleId)][punctuation . foo bar]');
  ...
  MT('html',
      '[comment <div articleId="wrapper">]',
      '[comment <section articleId="introduction">]',
      '',
